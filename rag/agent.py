...
rag_tool = VertexAiRagRetrieval(
    ...
    description=(
        "use this tool to retrieve documentation and reference materials for the question from RAG corpus"
    ),
    rag_resources=[
        rag.RagResource(
            rag_corpus="projects/agentic-ai-test-482915/locations/us-east1/ragCorpora/2305843009213693952",
        )
    ],
    similarity_top_k=10,
